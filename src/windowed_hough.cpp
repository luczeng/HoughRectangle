...
int main(int argc, char * argv[]){
    ...
    Matrix<float,Dynamic,Dynamic,RowMajor> wht = ht.windowed_hough(gray,config.r_min,config.r_max,config.thetaBins,config.rhoBins,config.thetaMin,config.thetaMax); 
